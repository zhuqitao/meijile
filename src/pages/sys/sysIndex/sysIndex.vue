    ...
    <div class="home-body">
        ...
        <mu-appbar title="Title" class="homeTitle">
            ...
            <mu-tabs v-if="!isMobile" :value="activeTab" class="homeNav">
                <mu-tab v-for="item in mainMenu" :key="item.menuId" :value="item.url" :title="item.name" @click="changeMianMenu(item.menuId, item.url)" />                
            </mu-tabs>
                ...
                <mu-menu class="menu">
                    <mu-menu-item title="个人资料">
                        <mu-badge content="" class="demo-icon-badge" slot="after">
                            <mu-icon value="account_circle" color="blue" />
                        </mu-badge>
                    </mu-menu-item>
        ...
        <mu-bottom-sheet :open="botMenuOpen" @close="closeBottomSheet">
            <mu-content-block>
                <div class="menuItem" v-for="item in mainMenu" :key="item.menuId">
