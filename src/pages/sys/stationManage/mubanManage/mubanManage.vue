    ...
    <div class="mubanManage" style="margin: 10px">
        ...
        <mu-dialog v-if="isShowDetail" :open="isShowDetail" title="详情" @close="isShowDetail = false" bodyClass="role-dia-log">
            <mu-list>
                ...
                <mu-list-item>
                   模板标题: {{showDetailData.title}}
                </mu-list-item>
                <mu-list-item>
                   模板介绍： {{showDetailData.info}}
                </mu-list-item>
                <mu-list-item>
                   链接： {{showDetailData.linkUrlstr}}
                </mu-list-item>
                <mu-list-item>
                   类型： {{showDetailData.type}}
                </mu-list-item>
                <mu-list-item>
                   开启状态： {{showDetailData.status}}
                </mu-list-item>
            </mu-list>
        ...
        <Table v-if="isMobile" class="station-table" border :columns="columnsMobile" :data="mubanList.content"></Table>
        <Table v-else class="station-table" border :columns="columns" :data="mubanList.content"></Table>
